...
class AIChatbot {
    constructor() {
        ...
        this.messages = [
            {
                type: 'bot',
                text: '👋 Hi! I\'m your AI restaurant assistant. How can I help you today?'
            },
            {
                type: 'user',
            ...
            {
                type: 'bot',
                text: 'Yes! We have 12 delicious gluten-free items on our menu. Would you like to see them?',
                typing: true
            }
        ];
        ...
        widget.innerHTML = `
            ...
            <div class="chatbot-window">
                ...
                <div class="chatbot-demo-label">
                    <span>✨ AI Demo - See it in action</span>
                </div>
            </div>
        `;
